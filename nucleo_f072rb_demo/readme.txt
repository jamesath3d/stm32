/**
  @page Demo STM32CubeF0_Demo_STM32F072RB-Nucleo.hex
 
  @verbatim
  ******************************************************************************
  * @file    readme.txt 
  * @author  MCD Application Team
  * @brief   Description of NUCLEO-F072RB RevC Demo
  ******************************************************************************
  *
...
@par Hardware and Software environment
  ...
  - This example has been tested with NUCLEO-F072RB RevC board and can be
...
using these binary files, as described below:
 ...
 + Using "in-system programming tool" such as ST-Link Utility
    - Connect the NUCLEO-F072RB board to a PC with a 'USB type A to Micro-B'
    ...
    - Make sure that the embedded ST-LINK/V2 is configured for in-system programming
      (both CN2 jumpers ON)
    - Use "STM32CubeF0_Demo_STM32F072RB-Nucleo.hex" binary with your preferred 
